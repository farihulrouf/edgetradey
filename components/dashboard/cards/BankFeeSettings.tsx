...
const BankFeeSettings = () => {
  ...
  const onSubmit = async (data: FeeFormData) => {
    ...
    toast.success("Bank fee settings saved successfully", {
    ...
    <Card className="w-full shadow-[var(--shadow-elevated)] border-border/50 transition-all duration-300 hover:shadow-[var(--shadow-card)]">
      ...
      >
        <div className="flex items-center justify-between">
          <CardTitle className="text-lg font-semibold text-foreground">Bank fee setting</CardTitle>
          <Dialog open={open} onOpenChange={setOpen}>
            ...
            <DialogContent>
              <DialogHeader>
                <DialogTitle>Edit Bank Fee Settings</DialogTitle>
              </DialogHeader>
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-4 pt-2">
                <div className="space-y-1">
                  <Label htmlFor="depositFee" className="text-sm font-medium text-foreground">Deposit Fee</Label>
                  <Input
                    id="depositFee"
                    type="text"
                    placeholder="0.00"
                ...
                <div className="space-y-1">
                  <Label htmlFor="withdrawalFee" className="text-sm font-medium text-foreground">Withdrawal Fee</Label>
                  <Input
                    id="withdrawalFee"
                    type="text"
                    placeholder="0.00"
...
export default BankFeeSettings;
