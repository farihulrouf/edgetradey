  ...
  return (
    <>
      <div className="bg-card rounded-lg border border-border flex flex-col min-h-[600px]">
          ...
          <table className="w-full text-sm border-collapse">
            ...
            <tbody>
              {traders.map((trader, idx) => (
                <tr
                  key={trader.userId}
                  className={`${idx % 2 === 1 ? "bg-muted/40" : ""} hover:bg-accent/50 cursor-pointer`}
        ...
        {/* Pagination footer */}
        <div className="flex-shrink-0 flex items-center justify-center gap-2 p-4 border-t border-border">
